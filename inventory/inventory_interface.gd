...
@onready var ammo_inventory = $AmmoInventory
...
func set_ammo_inventory_data(inventory_data: InventoryData) -> void:
	if inventory_data:
		ammo_inventory.show()
		if not inventory_data.inventory_interact.is_connected(on_inventory_interact):
			inventory_data.inventory_interact.connect(on_inventory_interact)
		ammo_inventory.set_inventory_data(inventory_data)

func clear_ammo_inventory_data() -> void:
	ammo_inventory.hide()
